  ...
  def test_inheritance_chain
    ...
    [
      trace(name: :foo, constant_updates: [
        ...
        A::B,
        A::B::C,
        to_constant(A::B::C::D, superclass: A::B, included_modules: [A, A::B::C, Enumerable], prepended_modules: [A::B::C::E], extended_modules: [A]),
        to_constant(A::B::C::E, included_modules: [A], prepended_modules: [A::B::C], extended_modules: [A::B::C]),
        A::B::C::F,
        to_constant(Enumerable, included_modules: [A]),
        Array,
        Racer,
        to_constant(Racer::Agent, superclass: Array),
        to_constant(Object, included_modules: [A]),
        "Delegator1234",
